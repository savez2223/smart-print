    ...
    <footer className="bg-primary text-primary-foreground py-12">
      <div className="container">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2 text-sm opacity-90">
              ...
              <li><a href="#" className="hover:opacity-100">Press Releases</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm opacity-90">
              ...
              <li><a href="#" className="hover:opacity-100">Installation Guide</a></li>
              <li><a href="#" className="hover:opacity-100">Troubleshooting</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-primary-foreground/20 pt-8 text-center text-sm opacity-90">
          <p>&copy; 2024 PC PACKARD. All rights reserved. | Privacy Policy | Terms & Conditions</p>
        </div>
      </div>
    </footer>
  );
