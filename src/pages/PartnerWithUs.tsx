...
import { Handshake, TrendingUp, Users, Globe, CheckCircle, ArrowRight } from "lucide-react";
  ...
  const partnerTypes = [
    {
      ...
      features: ["White-label solutions", "Volume discounts", "Sales training", "Marketing support"],
    },
    {
      title: "Referral Partner",
      desc: "Refer customers to us and earn commissions on every successful conversion.",
      features: ["Simple referral process", "Competitive commissions", "Real-time tracking", "Monthly payouts"],
    },
    {
      title: "Technology Partner",
      desc: "Integrate our services with your technology platform or software.",
      features: ["API access", "Technical documentation", "Integration support", "Co-marketing opportunities"],
    },
  ];
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto text-lg">
              Join our partner ecosystem and unlock new revenue opportunities while providing exceptional printer support services to your customers.
            </p>
          </div>
          ...
          {/* Partner Types */}
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-[#005bb5] mb-8 text-center">Partnership Programs</h2>
            <div className="grid md:grid-cols-3 gap-6">
              {partnerTypes.map((type, index) => (
                <div key={index} className="border border-gray-200 rounded-xl p-6 hover:border-[#06b6d4] hover:shadow-lg transition-all">
                  <h3 className="text-xl font-semibold text-[#005bb5] mb-3">{type.title}</h3>
          ...
          <section className="mb-16 bg-gray-50 rounded-2xl p-8 md:p-12">
            <h2 className="text-3xl font-bold text-[#005bb5] mb-8 text-center">How It Works</h2>
            <div className="grid md:grid-cols-4 gap-6">
              {[
                ...
                { step: "03", title: "Onboard", desc: "Get onboarded with training & resources" },
                { step: "04", title: "Grow", desc: "Start earning and growing together" },
              ].map((item, index) => (
                <div key={index} className="text-center relative">
                  <div className="w-16 h-16 bg-[#005bb5] text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">
                    {item.step}
                  </div>
          ...
          <div className="bg-gradient-to-r from-[#005bb5] to-[#06b6d4] rounded-2xl p-8 md:p-12 text-center text-white">
            ...
            <p className="mb-6 opacity-90 max-w-2xl mx-auto">
              Contact us today to learn more about our partnership programs and how we can grow together.
            </p>
            <a 
