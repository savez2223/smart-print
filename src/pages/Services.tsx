        ...
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto text-lg">
              From setup to troubleshooting, we provide end-to-end printer
              support services to ensure your printing needs are always met with
              excellence.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-16">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-xl hover:border-[#06b6d4] transition-all group"
              >
          ...
          <div className="bg-gradient-to-r from-[#0aa5d9] to-[#06b6d4] rounded-2xl p-8 md:p-12 text-center text-white">
            ...
            <p className="mb-6 opacity-90 max-w-2xl mx-auto">
              Our expert technicians are available 24/7 to assist you with any
              printer-related issues. Get in touch now for immediate support.
            </p>
            <a
